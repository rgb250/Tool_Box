...
- [Time Series Notes](#time-series-notes)
  - [1) Introduction](#1-introduction)
    ...
    - [c. AutoCoVariance Function (ACVF)](#c-autocovariance-funciton-acvf)

## 1) Introduction
###  a. Time Series Definition
The observed data $\{x_{t}\}_{t\in\mathbb{N}^{*}}$ are seen as realization of the following random variables $\{X_{t}\}_{t\in\mathbb{N}^{*}}$
### b. Stationarity
