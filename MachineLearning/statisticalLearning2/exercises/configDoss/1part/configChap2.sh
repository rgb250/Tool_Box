...
initialisation "2" "elementsOfStatisticalLearning" "The Elements of Statistical Learning"
#=====================================================================
#CRÉATION DES FICHIERS CENTRALISANT CHAQUE CHAPITRE 
declare -a chap=("OverviewOfSupervisedLearning" "LinearMethodsForRegression" 
"LinearMethodsForClassification" "BasisExpansionsAndRegularization" 
"KernelSmoothingMethods" "ModelAssessmentAndSelection"
"ModelInferenceAndAveraging" "AdditiveModelsTreesAndRelatedMethods" "BoostingAndAdditiveTrees" "NeuralNetworks" "SupportVectorMachinesAndFlexibleDiscriminants" "PrototypeMethodsAndNearest_Neighbors" "UnsupervisedLearning" "RandomForests" "EnsembleLearning" "UndirectedGraphicalModels" "High_DimensionalProblems")
declare -a nChap=("Overview of Supervised Learning" "Linear methods for Regression" 
"Linear methods for Classification" "Basis Expansions and Regularization" 
"Kernel Smoothing Methods" "Model Assessment and Selection"
"Model Inference and Averaging" "Additive Models, Trees and Related Methods" "Boosting and Additive Trees" "Neural Networks" "Support Vector Machines and Flexible Discriminants" "Prototype Methods and Nearest-Neighbors" "Unsupervised Learning" "Random Forests" "Ensemble Learning" "Undirected Graphical Models" "High-Dimensional Problems")
declare -a newChap=()
initialisation2
