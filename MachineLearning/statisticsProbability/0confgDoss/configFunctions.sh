...
initialisation () {
	...
	mkdir ~/Documents/Cours/Cours_2AE/Statistiques/fiche/chap/
	mkdir ~/Documents/Cours/Cours_2AE/Statistiques/fiche/chap/$1chap
	echo "Accès à la partie $1"
	cd ~/Documents/Cours/Cours_2AE/Statistiques/fiche/chap
	echo "Création du fichier qui centralisera tous les fichiers de la partie $1"
	eval j="$1_$2.tex"
	nomFichierPartie=$j
	echo -e "\\\begin{itemize}\n\t\\\item\n \\\end{itemize}" >> $j
	echo -e "\\\chapter{$3}\n\\\input{./chap/$j}" >> ../statisticalLearningSummary.tex
	echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
}

initialisation2 () {
	cd ~/Documents/Cours/Cours_2AE/Statistiques/fiche/chap/${numPartie}chap
	for ((i=0; i<${#chap[@]}; i++))
	do
...
function creation {
	...
	mkdir ~/Documents/Cours/Cours_2AE/Statistiques/fiche/chap/${numPartie}chap/${files[0]}sec
	echo "Accès à la section '${files[0]}sec'"
	cd ~/Documents/Cours/Cours_2AE/Statistiques/fiche/chap/${numPartie}chap/${files[0]}sec
