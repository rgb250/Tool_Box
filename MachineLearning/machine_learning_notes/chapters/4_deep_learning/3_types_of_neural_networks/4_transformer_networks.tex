...
\begin{center}
    \fr{$Attention\left(\bm{Q},\bm{K},\bm{V}\right)\sigma\left(\dfrac{\bm{Q}\bm{K}^{T}}{\sqrt{d_{k}}}\right)V$}
\end{center}
...
\begin{center}
    \fr{$MultiHead\left(\bm{Q},\bm{K},\bm{V}\right) = Concat(head_{1}, \ldots, head_{h})P^{O}$}
\end{center}
