...
\subparagraph{Objectivist interpretation \cite{wiki:probability_interpretation}}: assigns
...
\subparagraph{Subjectivist interpretation \cite{wiki:probability_interpretation}}: assigns
...
\subparagraph{Event and its opposite}
$\Prob{A} + \Prob{\overline{A}} = 1$
\subparagraph{Not necessary mutually exclusive events}
...
\subparagraph{Law of Total Probability}
$
\begin{cases}
...
\subparagraph{$n^{th}$ moments of a random variable:}
...
\subparagraph{Skewness and Kurtosis}
\begin{itemize}
...
\subparagraph{Chebychev inequality}
...
\subparagraph{Markov inequality}
\begin{center}
		$X\neq\underline{0}\Rightarrow \Prob{X\geq t}\leq \dfrac{\E{X}}{t}$
\end{center}
\subparagraph{Theorem weak law of large numbers:}
...
\end{center}
\subparagraph{Convergence in probability}
...
\end{center}
\subparagraph{Convergence almost surely}
...
\subparagraph{Joint probability density function}
...
\subparagraph{Marginal probability density function}
...
\end{cases}$
\end{center}
\subparagraph{Joint cumulative probability distribution function}
